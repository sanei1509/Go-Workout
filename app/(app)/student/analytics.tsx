                ...
                <View style={s.heroCard}>
                  ...
                  <View style={s.heroBody}>
                    ...
                    <View style={s.heroRight}>
                      ...
                      <View style={[s.miniStat, { borderTopWidth: 1, borderTopColor: T.border }]}>
            ...
            >
              ...
              >
                <View style={s.ctaIcon}>
                  <Ionicons name="stats-chart-outline" size={24} color={T.action} />
                </View>
                <View style={{ flex: 1 }}>
            ...
            {records.length === 0 ? (
              <View style={s.emptyCard}>
                <View style={s.emptyIcon}>
                  <Ionicons name="trophy-outline" size={32} color={T.attention} />
                </View>
                ...
                {records.map((record, idx) => (
                  ...
                  >
                    <View style={[s.recordRow, idx < records.length - 1 && s.recordRowBorder]}>
                      ...
                      <Ionicons name="chevron-forward" size={14} color={T.border} style={{ marginLeft: 4 }} />
                    </View>
                  </TouchableOpacity>
                ))}
              </View>
...
function createStyles(T: ThemeTokens, actionDimBg: string) {
  return StyleSheet.create({
    ...
    // Hero stats card
    heroCard:    { backgroundColor: T.surfaceElevated, borderRadius: 14, borderWidth: 1, borderColor: T.action, marginBottom: 16, overflow: 'hidden' },
    heroTopLine: { height: 2, opacity: 0.6 },
    heroBody:    { flexDirection: 'row', padding: 20 },
    heroLeft:    { flex: 1, paddingRight: 16 },
    heroLabel:   { color: T.textSecondary, fontSize: 10, fontFamily: 'SpaceGrotesk_700Bold', letterSpacing: 2, marginBottom: 6 },
    heroValue:   { color: T.textPrimary, fontSize: 34, fontFamily: 'SpaceGrotesk_700Bold', letterSpacing: -1 },
    heroUnit:    { color: T.textSecondary, fontSize: 18, fontFamily: 'SpaceGrotesk_400Regular' },
    ...
    heroRight:   { borderLeftWidth: 1, borderLeftColor: T.border, paddingLeft: 16, justifyContent: 'center', gap: 0 },
    ...
    miniLabel:   { color: T.textSecondary, fontSize: 9, fontFamily: 'SpaceGrotesk_700Bold', letterSpacing: 2, marginTop: 2 },

    // CTA card
    ctaCard:     { borderRadius: 12, marginBottom: 28, overflow: 'hidden', borderWidth: 1, borderColor: actionDimBg },
    ...
    ctaTitle:    { color: T.action, fontSize: 13, fontFamily: 'SpaceGrotesk_700Bold', letterSpacing: 1, marginBottom: 3 },
    ctaSub:      { color: T.textSecondary, fontSize: 12, fontFamily: 'SpaceGrotesk_400Regular' },

    // Records
    recordList:      { backgroundColor: T.surfaceElevated, borderRadius: 12, borderWidth: 1, borderColor: T.border, overflow: 'hidden' },
    recordRow:       { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 },
    recordRowBorder: { borderBottomWidth: 1, borderBottomColor: T.border },
    rankWrap:        { width: 28, alignItems: 'center', marginRight: 12 },
    rankNum:         { color: T.textSecondary, fontSize: 13, fontFamily: 'SpaceGrotesk_700Bold' },
    ...
    prValue:         { color: T.action, fontSize: 15, fontFamily: 'SpaceGrotesk_700Bold' },
    prSets:          { color: T.textSecondary, fontSize: 11, fontFamily: 'SpaceGrotesk_400Regular', marginTop: 1 },

    // Empty
    emptyCard:  { backgroundColor: T.surfaceElevated, borderRadius: 12, borderWidth: 1, borderColor: T.border, padding: 40, alignItems: 'center' },
    ...
    emptyTitle: { color: T.textPrimary, fontSize: 13, fontFamily: 'SpaceGrotesk_700Bold', letterSpacing: 2, marginBottom: 8 },
